...
AS SELECT * FROM cloud_files("/Workspace/ts_demos/iot_data/turbine", "parquet", map("cloudFiles.inferColumnTypes" , "true"))
...
AS SELECT * FROM cloud_files("/Workspace/ts_demos/iot_data/incoming_data", "parquet", map("cloudFiles.inferColumnTypes" , "true"))
...
AS SELECT * FROM cloud_files("/Workspace/ts_demos/iot_data/historical_turbine_status", "parquet", map("cloudFiles.inferColumnTypes" , "true"))
